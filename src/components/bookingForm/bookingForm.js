...
import b from './bookingForm.scss';
    ...
    render() {
        ...
        return (
            <div className="container">
                <div className={b.bookingHeader}>
                    <h1>Experience a <span className={b.textEmphasis}>Krew</span> Ride.</h1>
                </div>
                <div className={b.bookingForm}>
                    <PlacesAutocomplete
                    ...
                    <Row className={b.riderPanel}>
                        <Col md={5}>
                            <h3 className={b.ridersHeader}>How big is your Krew?</h3>
